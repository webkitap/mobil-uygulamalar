...
![Component Tree paneli](./ekran-tasarimi/component-tree-paneli.png)

Bu aşamada istenen yerleşim ismi seçilir ve Apply düğmesine tıklanır (Görsel 2.19).

![Layout Çeşitleri](./ekran-tasarimi/layout-cesitleri.png)
...
![ConstraintLayout içinde TextView ve Button görünümleri](./ekran-tasarimi/constraintlayout-icinde-textview-ve-button-gorunumleri.png)
...
![Constrait ayarı](./ekran-tasarimi/constrait-ayari.png)
...
![Görünümler](./ekran-tasarimi/gorunumler.png)
...
![LinearLayout (Yatay)](./ekran-tasarimi/linearlayout-yatay.png)
...
![LinearLayout (Dikey)](./ekran-tasarimi/linearlayout-dikey.png)
...
![Yatay LinearLayout yerleşimi](./ekran-tasarimi/yatay-linearlayout-yerlesimi.png)
...
![RelativeLayout](./ekran-tasarimi/relativelayout.png)
...
![RelativeLayout yerleşimi](./ekran-tasarimi/relativelayout-yerlesimi.png)
...
![FrameLayout yerleşimi parametreleri](./ekran-tasarimi/framelayout-yerlesimi-parametreleri.png)
...
![FrameLayoout yerleşimi](./ekran-tasarimi/framelayout-yerlesimi.png)
