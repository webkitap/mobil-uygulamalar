...
![TextView ön izleme](./ekran-tasarimi/textview-on-izleme.png)
...
![XML görünüm kodlarının yazılacağı alan](./ekran-tasarimi/xml-gorunum-kodlarinin-yazilacagi-alan.png)
...
![Design ekranında görünüm](./ekran-tasarimi/design-ekraninda-gorunum.png)

**SIRA SİZDE**: 

>Mobil uygulama geliştirme ortamında tasarım ekranına XML kodlarıyla yeşil
renkli, 60 sp boyutunda, kenar boşlukları 25 dp olan “Yazılım Geliştirme” yazısını yazdırınız.
...
![EditText ön izleme](./ekran-tasarimi/edittext-on-izleme.png)
...
![Button ön izleme](./ekran-tasarimi/button-on-izleme.png)
...
![Resim dosyasının drawable dizinine yerleştirilmesi](./ekran-tasarimi/resim-dosyasinin-drawable-dizinine-yerlestirilmesi.png)
...
![ImageView ön izleme](./ekran-tasarimi/imageview-on-izleme.png)
...
![CheckBox ön izleme](./ekran-tasarimi/checkbox-on-izleme.png)
...
![ProgressBar ön izleme](./ekran-tasarimi/progressbar-on-izleme.png)