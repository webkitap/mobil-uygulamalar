...
![Değişken tipleri](./temel-komutlar/degisken-tipleri.png)
...
![New Project komutu](./temel-komutlar/new-project-komutu.png)


**2. Adım**: New Project penceresinden Empty Activity seçeneğini seçip Next düğmesine tıklayınız (Görsel 3.9).

![New Project penceresi](./temel-komutlar/new-project-penceresi.png)
...
![New Project No Activity penceresi](./temel-komutlar/new-project-no-activity-penceresi.png)

**4. Adım**: Project penceresinde app>java üzerine sağ tıklayıp New>Java Class’ı tıklayınız (Görsel 3.11).

![Yeni Java sınıfı oluşturma](./temel-komutlar/yeni-java-sinifi-olusturma.png)
...
![Choose Destination Directory penceresi](./temel-komutlar/choose-destination-directory-penceresi.png)

**6. Adım**: New Java Class penceresinde Name kısmına “DenemeMantiksal” yazarak yeni bir sınıf oluşturunuz (Görsel 3.13). 

![New Java Class penceresi](./temel-komutlar/new-java-class-penceresi.png)
...
![Run with Converage komutu](./temel-komutlar/run-with-coverage-komutu.png)

**9. Adım**: Cover penceresinde çalışan kodun çıktısını inceleyiniz(Görsel 3.15).

![Cover penceresi](./temel-komutlar/cover-penceresi.png)
...
![Byte ile bit ilişkisi](./temel-komutlar/byte-ile-bit-iliskisi.png)
...
|---|---|---|
|byte|1byte (8 bit)|-127,…,127|
|short|2byte|-32768,…,32767|
|int|4byte|-2147483648,…,2147483647|
|long|8byte|-9223372036854775808,…,9223372036854775807|
|char|2byte|0,…,65535 arası Unicode ile kodlanmış karakter|

Tam sayı veri tipleri büyüklükleri Görsel 3.17’de verilmiştir.

![Tam sayı veri türlerinde büyüklük karşılaştırması](./temel-komutlar/tam-sayi-veri-turlerinde-buyukluk-karsilastirmasi.png)
...
![char veri türü](./temel-komutlar/char-veri-turu.png)
...
![Stack ve heap hafıza](./temel-komutlar/stack-ve-heap-hafiza.png)
